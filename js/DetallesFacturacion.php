...
$(() => {
    ...
    const dataTableFacturas = $('#dataTableFacturas').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '<?php echo SERVERURL; ?>php/DetallesFacturacion/DetallesFacturacion.php',
            type: 'POST'
        },
        columns: [
    ...
    $('#form-filtros-facturas').on('submit', function(e) {
        e.preventDefault();
        dataTableFacturas.ajax.url('<?php echo SERVERURL; ?>php/DetallesFacturacion/DetallesFacturacion.php?' + $(this).serialize()).load();
    });
    ...
    $('#btn-limpiar-filtros').click(function() {
        ...
        dataTableFacturas.ajax.url('<?php echo SERVERURL; ?>php/DetallesFacturacion/DetallesFacturacion.php').load();
    });
    ...
    function pagarFactura(facturaId) {
        $.ajax({
            url: '<?php echo SERVERURL; ?>php/DetallesFacturacion/pagarFactura.php',
            type: 'POST',
            dataType: 'json',
            data: { 
            ...
            success: function(response) {
                if (response.type === 'success' && response.data && response.data.length > 0) {
                    ...
                    if (facturaEncontrada) {
                        ...
                        $.ajax({
                            url: '<?php echo SERVERURL; ?>php/DetallesFacturacion/getDetalleFactura.php',
                            type: 'POST',
                            dataType: 'json',
                            data: { 
                                facturas_id: facturaId,
