...
function getTotalFacturasDisponibles(){
    ...
    $.ajax({
        ...
        success: function(valores) {
            ...
            // Elementos del DOM
            var counter = $('#facturas-counter');
            var counterHeader = $('#counter-header');
            var counterStatus = $('#counter-status');
            var counterNumber = $('#counter-number');
            var counterFooter = $('#counter-footer');
            var counterIcon = $('.counter-icon i');
            
            // Actualizar rangos
            $('#rango-inicial').text(rangoInicial);
            $('#rango-final').text(rangoFinal);
        ...
        error: function(xhr, status, error) {
            ...
            $('#counter-header').html('<strong>ERROR DE CONEXIÓN</strong>');
            $('#counter-status').text('No se pueden cargar los datos').addClass('status-danger');
