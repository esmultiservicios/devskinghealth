...
while($registro2 = $result->fetch_assoc()){						
	$tabla = $tabla.'<tr>
	   ...
	   <td>
		   <a style="text-decoration:none;" href="javascript:modal_eliminarJornadaColaboradores('.$registro2['colaborador_id'].', '.$registro2['id'].');void(0);" class="fas fa-trash fa-lg"></a>
	   </td>
  </tr>';
}
