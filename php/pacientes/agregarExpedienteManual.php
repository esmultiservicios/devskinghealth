...
if ($result->num_rows > 0) {
	...
	$insert = "INSERT INTO historial_pacientes VALUES ('$pacientes_id_historial','$pacientes_id','$expediente_sistema','$identidad','$nombre','$apellido','$sexo','$telefono1','$telefono2','$fecha_nacimiento','$correo','$fecha','$departamento_id','$municipio_id','$localidad','$religion_id','$profesion_id','$usuario','$estado','$observacion','$fecha_registro')";
