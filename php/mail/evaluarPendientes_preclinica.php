...
if($result_empresa->num_rows>0){
  ...
  $mensaje="
       <table class='table table-striped table-responsive-md btn-table'>
         ...
         <tr>
            <td colspan='2'><center><b><h4>Reporte de Registros Pendientes Preclinica</h4></b></center></td>
         </tr>
         <tr>
         ...
         <tr>
            <td>
	           <p style='text-align: justify'>
			      Estimado(a) <b>$consulta_colaborador</b>, se le recuerda que tiene un total de <b>$total_agenda</b> $string_agenda en el mes de <b>$mes_acutal, $año.
		          </b><br/>Los cuales debe realizar la Preclinica. No debe dejar ningun registro pendiente dentro de este mes.</p>
